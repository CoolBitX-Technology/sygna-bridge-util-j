...
public class PacketSerializerTest {
    ...
    public void testPermissionSerialize() {
        ...
        Permission pemission2 = new Permission(signature, transferId, permissionStatus, expireDate);
        ...
        Permission pemission3 = new Permission(signature, transferId, permissionStatus, expireDate, rejectCode, rejectMessage);
        JsonElement jsonElement3 = gson.toJsonTree(pemission3, Permission.class);
        assertEquals(jsonElement3.toString(), expectedMessage2);

        permissionStatus = PermissionStatus.REJECTED.getStatus();
        Permission pemission4 = new Permission(signature, transferId, permissionStatus, expireDate, rejectCode, rejectMessage);
        ...
        rejectMessage = "unsupported_currency";
        Permission pemission5 = new Permission(signature, transferId, permissionStatus, expireDate, rejectCode, rejectMessage);
        ...
        permissionStatus = PermissionStatus.ACCEPTED.getStatus();
        Permission pemission6 = new Permission(signature, transferId, permissionStatus, rejectCode, rejectMessage);
        JsonElement jsonElement6 = gson.toJsonTree(pemission6, Permission.class);
        assertEquals(jsonElement6.toString(), expectedMessage);

        permissionStatus = PermissionStatus.REJECTED.getStatus();
        rejectMessage = "";
        Permission pemission7 = new Permission(signature, transferId, permissionStatus, rejectCode, rejectMessage);
        ...
        rejectMessage = "unsupported_currency";
        Permission pemission8 = new Permission(signature, transferId, permissionStatus, rejectCode, rejectMessage);
